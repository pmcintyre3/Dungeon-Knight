...
.defines(function(){
        EntityPlayer = ig.Entity.extend({
            ...
            update: function () {
                ...
                if(!this.climbing && this.standing && ig.input.state('left')){
                ...
                else if(!this.climbing && this.standing && ig.input.state('right')){
                    if(!ig.input.state('block')){
                ...
                else if(!this.climbing && this.standing && ig.input.pressed('jump')){
                    if(!ig.input.state('block')){
                        //if(this.flip == false)
                ...
                if(this.standing && this.overLadder){
