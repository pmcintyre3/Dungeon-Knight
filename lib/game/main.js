    ...
    MyGame = ig.Box2DGame.extend({
        ...
        IntermediateScreen =  ig.Game.extend({
            ...
            draw: function() {
                ...
                this.instructText.draw("Are you willing to fight for the ones you love?", x, y + 20, ig.Font.ALIGN.CENTER);
                this.instructText.draw("Arrow keys - move, space - jump, Z - block, x - switch, c - attack", x, y + 40, ig.Font.ALIGN.CENTER);
